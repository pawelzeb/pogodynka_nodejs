...
import com.projekt.pogodynka.adapters.HistoryAdapter
import com.projekt.pogodynka.placeholder.PlaceholderContent;
import com.projekt.pogodynka.databinding.FragmentHistoryListBinding

/**
 * A Fragment representing a list of Pings. This fragment
 * has different presentations for handset and larger screen devices. On
 * handsets, the fragment presents a list of items, which when touched,
 * lead to a {@link HistoryDetailFragment} representing
...
class HistoryListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val itemDetailFragmentContainer: View? =
            view.findViewById(R.id.history_detail_nav_container)
    ...
    private fun setupRecyclerView(
        ...
        val city:String = sharedPreferences.getString(Globalne.CITY, "").toString()
        val cc = sharedPreferences.getString(Globalne.CC, "").toString()
        if(city.isEmpty() || cc. isEmpty()) {
            binding.nodata.visibility = View.VISIBLE
            binding.historyList.visibility = View.INVISIBLE
            return
        }
        PlaceholderContent.init(city, cc)
